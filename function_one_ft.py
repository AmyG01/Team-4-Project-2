...
def dictionary_of_metrics(items) :
    ...
    if count % 2 == 1:
        return sorted_items[int(round(count+1)/2-1)]
    else:
    ...
    dict = {'mean':the_mean,'median': the_median,'varience':the_varience,
    'standard deviation':the_standard_dev,'min':the_min,'max':the_max}
